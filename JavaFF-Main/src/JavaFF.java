...
public class JavaFF
{
  ...
  */
  ...
  infoOutput.println("Performing search as in FF - first considering HC with HelpfulFilter & RouletteSuccessorSelector");
  ...
  if (goalState == null){
    infoOutput.println("LCS failed, using Enforced HillClimbing search, with HelpfulFilter actions");
    EnforcedHillClimbingSearch EHCS = new EnforcedHillClimbingSearch(initialState);
  ...
  if (goalState == null){
    infoOutput.println("EHCS + HelpfulFilter failed , using Enforced HillClimbing search, with all actions");
    EnforcedHillClimbingSearch EHCS = new EnforcedHillClimbingSearch(initialState);
    EHCS.setFilter(HelpfulFilter.getInstance());
    goalState = EHCS.search();
  }
